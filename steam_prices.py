...
Ellenőrizni, hogy a target price az egyenlő vagy kisebb, mint a final price. Majd ha megvan, és igaz akkor kihozzon egy ablakot, azzal, hogy elérte a targetet
...
try:
    ...
    print("Faile to import requests")
    try:
        choice = input("Install pygeoip? [y/n] ")
